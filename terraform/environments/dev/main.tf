# Stockfolio Development Environment - Main Terraform Configuration
# This configuration creates the complete infrastructure for the Stockfolio application
...
# Namespace variable for deployments
locals {
      ...
      spec {
        container {
          ...
          env {
            ...
            value = "jdbc:mysql://mysql.stockfolio.svc.cluster.local:3306/stockdb?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true&createDatabaseIfNotExist=true"
          }
          ...
          env {
            ...
            value = "http://wallet:8091"
          }

          env {
            name  = "MARKET_DATA_BASE_URL"
            value = "http://market-data:7666"
          }
...
resource "kubernetes_ingress_v1" "stockfolio_alb" {
  metadata {
    ...
    annotations = {
      ...
      "external-dns.alpha.kubernetes.io/hostname"        = "stockfolio.dev.example.com"
